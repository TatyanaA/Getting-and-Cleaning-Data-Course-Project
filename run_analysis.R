...
#Reading data
#getwd()
#setwd("/home/delka/Documents/Coursera/Getting and Cleaning Data/work_directory")
...
#data_r
#getwd()
write.table(data_r,"data_group.txt",sep="\t",row.names=F)
write.table(X_all,"X_all.txt",sep="\t",row.names=F)
